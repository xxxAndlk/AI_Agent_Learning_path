...
GPTQ（Accurate Post-Training Quantization for Generative Quantized Transformers）是一种针对大语言模型设计的量化方法，可以在保持模型性能的同时实现超低比特量化。GPTQ的核心思想是在量化过程中引入Hessian矩阵来指导量化，减少量化误差。
