...
| 模型 | 架构 | 参数量 | 特点 |
|---|---|---|---|
| GPT-5.4 | 解码器 | ~1.7T(MoE) | 多模态、推理能力强 |
...
| GPT-5.4 | 120+ | 约20000 | 约100 | ~1.7T | 32K+ |
...
| LLaMA3.3-70B | 80 | 8192 | 8 | 70B | 128K |
...
| 10^26 FLOPs | 500B+ | 10T+ | GPT-5.4 (估算) |
